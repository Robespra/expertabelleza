...
export const metadata: Metadata = {
  title: "Top 5 Depiladoras IPL en 2025 - Comparativa Completa | ExpertaBelleza",
  ...
  keywords: "depiladora luz pulsada, IPL, reducción vello, comparativa IPL 2025, mejor depiladora IPL, depilación en casa, luméor Pulse Pro",
  openGraph: {
    type: 'website',
    locale: 'es_ES',
    url: 'https://expertabelleza.es/comparativa-depiladoras-ipl-luz-pulsada-2025',
    title: 'Comparativa: Top 5 Depiladoras IPL en 2025 | ExpertaBelleza',
  ...
  twitter: {
    ...
    title: 'Top 5 Depiladoras IPL 2025 | Test Completo y Comparativa',
